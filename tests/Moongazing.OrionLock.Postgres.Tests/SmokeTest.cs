...
public sealed class SmokeTest : IClassFixture<PostgresContainerFixture>
{
    ...
    public async Task AddOrionLock_UsePostgres_AcquireDispose_Works()
    {
        ...
        services.AddOrionLock().UsePostgres(fx.ConnectionString);
    ...
    public async Task TwoConsumers_AcquireSerialise()
    {
        ...
        services2.AddOrionLock().UsePostgres(fx.ConnectionString);
