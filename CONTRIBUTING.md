...
Thanks for taking the time to look at this. OrionLock is a small distributed-lock abstraction with Postgres, SQL Server, and Redis backends. The project is small and the bar for contributions is "does it make the package clearer, faster, or safer without expanding the public surface needlessly."
